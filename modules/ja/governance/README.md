...
ガバナンスモジュールは、協力基盤および組織連盟の意思決定、権限管理、変更手続きを扱います。初期運用は [提案](../../../proposals/ja/README.md)、[意思決定](../../../decisions/ja/README.md)、[ガバナンスプロセス](../../../assets/diagrams/03-governance-process.md) に接続します。
...
ガバナンスは、すべての [モジュール](../README.md) の変更手続きと接続します。

[アイデンティティ](../identity/README.md) から参加資格や役割を参照し、[仲裁](../arbitration/README.md) と連携して異議申し立てや紛争を扱います。ただし、ガバナンスが生活支援や経済アクセスを恣意的に支配しないようにします。
