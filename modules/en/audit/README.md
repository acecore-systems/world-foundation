...
The Audit Module handles transparency, audit logs, decision history, accounting transparency, authority changes, and conflict-of-interest records.

Audit is not a tool for creating surveillance. It must separate transparency from privacy.

## Problem

Cooperation infrastructure becomes corrupt or untrusted when decisions, accounting, authority changes, support judgments, reputation evaluations, or arbitration decisions become opaque.
...
- Governance: records decisions and authority changes
...
- What should be public and what should be protected?
