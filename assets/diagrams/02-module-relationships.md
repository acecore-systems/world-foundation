...
この図は、[modules/ja](../../modules/ja/README.md) の初期モジュール同士の関係を示します。矢印は支配関係ではなく、[アーキテクチャ](../../docs/ja/02-architecture.md) が前提にする参照・連携・検証の関係です。
...
flowchart LR
  ...
  click Decisions "../../decisions/ja/README.md" "意思決定"
```
