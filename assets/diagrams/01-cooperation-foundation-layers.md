...
flowchart TB
  ...
  click People "https://github.com/acecore-systems/world-foundation/blob/main/docs/ja/00-vision.md" "ビジョン"
  click Interface "https://github.com/acecore-systems/world-foundation/blob/main/docs/ja/01-principles.md" "参加・離脱・多重所属"
